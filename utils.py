import ctypes
from ctypes import c_size_t, c_char_p, c_void_p, c_int, c_uint, c_ubyte, POINTER, Structure, create_string_buffer, CFUNCTYPE
import ctypes.util
import os
import sys
import base64
...
class LibraryManager:
    ...
    def sign(self, cmd: str, seq: int, src: bytes):
        ...
        ret = self.func_ptr(c_char_p(cmd.encode()), src_ptr, c_uint(len(src)), c_int(seq), out_ptr)
